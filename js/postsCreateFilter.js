...
const filterBtnEl = document.getElementById('btnFilter');
const filterInputEl = document.getElementById('filter');

//sukuriam funkcija render, kuri sugeneruos postus
const render = (arrOfPosts) => {
  ...
  //kiekvienam render paduotam argumentui (render(arrOfPosts)) jo viduje darome for each: 1)sukuriam posta ir 2)ikeliam i DOM;
  arrOfPosts.forEach((pObj) => {
    // sukuriu elementa su createPostLi (aprasyta)
